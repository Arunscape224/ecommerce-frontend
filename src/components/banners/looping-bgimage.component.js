    ...
    return (
        <Container fluid className="d-flex align-items-center ">
            ...
            <div className="h-100 d-flex justify-content-between"  style={{width: '100%'}}>
                <Container fluid>
                    <Row>
                    <Col sm="7" className="left-banner border d-flex justify-content-center align-items-center">
                    ...
                    <Col sm="5" id="right-banner" style={{ height: '320px' }} className="border h-100">
