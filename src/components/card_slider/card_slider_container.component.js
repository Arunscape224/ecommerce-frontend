...
const CardSliderContainer = () => {
    ...
    return (
        <div className="mt-5 card-slider-container" style={{marginBottom: '150px', zIndex: '10000000000000'}}>
          
          <Col className="d-flex justify-content-between align-items-center  position-absolute" style={{ height: '325px', zIndex: '10000000000000' }}>
            <div className="d-flex justify-content-between w-100 align-items-center" style={{ height: '325px', zIndex: '10000000000000' }}>
